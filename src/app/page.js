      ...
      <main id='home' className='bg-white px-10 md:px-20 lg-px-40 dark:bg-gray-950'>
        <section>
          <nav className='py-10 flex justify-between'>
            ...
            <ul className='flex items-center'>
              <li>
                  <a href='https://drive.google.com/uc?export=download&id=1_dbdBVcPezmVT1ccUFJHedXzFzxMqGmu' download="pedro_resume.pdf" class="hover:underline bg-blue-400 p-1 rounded-sm me-4 sm:pl-5 md:me-6 dark:text-white">Resume</a>
              </li>
              <li >
                {
                  darkMode ? 
        ...
        <footer class="bg-white dark:bg-gray-950">
            <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
              <span class="text-sm text-gray-600 sm:text-center dark:text-gray-300">2024 <a href="https://kielblock.dev/" class="hover:underline">kielblock.dev</a>
            </span>
