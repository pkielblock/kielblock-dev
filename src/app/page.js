      ...
      <main id='home' className='bg-white px-10 md:px-20 lg-px-40 dark:bg-gray-950'>
        <section>
          <nav className='py-10 flex justify-between'>
            ...
            <ul className='flex items-center'>
              <li>
                  <a href='https://drive.google.com/uc?export=download&id=1_dbdBVcPezmVT1ccUFJHedXzFzxMqGmu' 
                  download="pedro_resume.pdf" class="hover:underline bg-blue-400 p-1 rounded-sm me-4 md:me-6 
                  dark:text-white">Resume</a>
              </li>
              <li >
                {
                  darkMode ? 
                  <MdLightMode onClick={() => setDarkMode(!darkMode)} className='hover:scale-110 transition duration-250 
                  cursor-pointer text-2xl dark:text-white'/> 
                  : 
                  <MdDarkMode onClick={() => setDarkMode(!darkMode)} className='hover:scale-110 transition duration-250 
          ...
          <div className='mb-10 relative mx-auto rounded-full w-40 h-40 overflow-hidden md:mb-11'>
            ...
            <div className='text-5xl flex justify-center gap-16 py-20 text-gray-950  dark:text-white'>
              <a href='https://github.com/pkielblock' target='_blank'><AiFillGithub className='hover:scale-110 
              transition duration-250 '/></a>
              <a href='https://www.linkedin.com/in/pedrokielblock/' target='_blank'><AiFillLinkedin 
              className='hover:scale-110 transition duration-250'/></a>
              <a href='mailto:pedro@kielblock.dev' target='_blank'><AiFillMail className='hover:scale-110 transition 
              duration-250'/></a>
            </div>
        ...
        <section>
          <div className='mb-10'>
            ...
            <p className='text-md py-2 leading-8 text-gray-600 md:text-xl md:leading-10 max-w-xl mx-auto  
            dark:text-gray-300'>
          ...
          <div>
            ...
            <div className='text-5xl flex justify-center gap-10 py-3 text-gray-950  dark:text-white'>
              <div className='p-1 hover:scale-110 transition duration-250'><FaJava/>
              <span className='pl-2 text-sm'>Java</span></div>
              <div className='p-1 hover:scale-110 transition duration-250'><BiLogoSpringBoot/>
              <span className='pl-1 text-sm'>Spring</span></div>
              <div className='p-1 hover:scale-110 transition duration-250'><DiMysql/>
              <span className='text-sm pl-1'>MySQL</span></div>
              <div className='p-1 hover:scale-110 transition duration-250'><DiLinux/>
              <span className='text-sm pl-2'>Linux</span></div>
            </div>
            <p className='text-md mb-10 py-2 leading-8 text-gray-600 md:text-xl max-w-xl mx-auto md:leading-10  
            dark:text-gray-300'>
              I specialize in Web Development, with a particular emphasis on <span className='font-bold  
              dark:text-white'>backend</span> technologies using <span className='font-bold  dark:text-white'>
                Java</span> and <span className='font-bold  dark:text-white'>Spring Boot</span>. 
              While my primary expertise lies in this area, I maintain a flexible and expansive approach to learning. 
              I am continuously exploring and studying various other areas and programming languages, ensuring a 
              well-rounded and adaptable skill set in the ever-evolving field 
              of web development.
            </p>
          </div>
        </section>
        <footer class="bg-white dark:bg-gray-950">
            <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
              <span class="text-sm text-gray-600 sm:text-center dark:text-gray-300"><a href="https://kielblock.dev/" 
              class="hover:underline">kielblock.dev</a>
            </span>
