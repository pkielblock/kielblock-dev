...
const Projects = () => {
    const projects = [
        ...
        },
        {
            ...
            description: "A comprehensive analytics platform that provides real-time insights and reporting capabilities for business intelligence.",
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                        A showcase of my recent work, ranging from full-stack web applications to mobile apps and data analytics solutions.
                    </p>
                </div>
